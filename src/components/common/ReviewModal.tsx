                        ...
                        <form onSubmit={handleSubmit} className="p-6 pt-2 space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <StarRating
                                    ...
                                    size={32}
                                    className="justify-center py-2 bg-accent/20 rounded-2xl border border-primary/5"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <Textarea
                                    ...
                                    className="min-h-[80px] rounded-2xl bg-accent/20 border-none focus-visible:ring-1 focus-visible:ring-[#D4A017]/30 text-base font-medium p-4"
                                />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {previews.length > 0 ? (
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => fileInputRef.current?.click()}
                                        className="w-full h-20 rounded-2xl border-2 border-dashed border-border/10 flex flex-col items-center justify-center gap-2 text-muted-foreground hover:border-[#D4A017]/40 hover:text-[#D4A017] hover:bg-[#D4A017]/5 transition-all"
                                    >
                                        <Upload size={20} />
                                        <span className="text-[10px] font-bold uppercase tracking-widest">Uploader des photos</span>
                                    </button>
                                )}
                            </div>
                            ...
                            <Button
                                ...
                                className="w-full h-12 rounded-2xl bg-[#D4A017] hover:bg-[#B8860B] shadow-xl shadow-yellow-600/20 font-black uppercase tracking-widest text-sm group"
                            >
                                {isSubmitting ? <Loader2 className="animate-spin" size={20} /> : (
                                    <>Envoyer Mon Avis <Send size={18} className="ml-3 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" /></>
                                )}
                            </Button>
                        </form>
                    </motion.div>
